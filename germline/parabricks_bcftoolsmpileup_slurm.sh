...
#SBATCH --job-name=bcfmpileup-parabricks    # Job name    # default: script name or sbatch
#SBATCH --output=job%j_bcfmpileup.log           # Output file    # default: slurm-<jobid>.out
...
pbrun bcftoolsmpileup \
	...
	--out-file ${VCFDATA}/${SAMPLE}_mpileup.bcf \
	--num-threads 12 \
	--bcf \
	--min-mapq 20

pbrun bcftoolscall \
	--in-file ${VCFDATA}/${SAMPLE}_mpileup.bcf \
	--num-threads 4 \
	--out-file ${VCFDATA}/${SAMPLE}_bcftools.vcf \
	--variant-sites
