...
export REF=/shared/example_data/hg19bundle
# User-input
FASTQDATA=$1
BAMDATA=$2
VCFDATA=$3
...
pbrun somatic \
	--ref ${REF}/ucsc.hg19.fasta \
	--knownSites ${REF}/Mills_and_1000G_gold_standard.indels.hg19.sites.vcf.gz \
	--num-gpus=2 \
...
filter_m2_singularity.hg19.sh ${VCFDATA} ${TUMOR}
